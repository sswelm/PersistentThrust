...
namespace PersistentThrust
{
    public static class VesselExtension
    {
        ...
        private static bool hasPersistentThrustEnabled = false;
        [KSPField(isPersistant = true)]
        private static bool didCheckPTEnabled = false;
        ...
        public static bool HasPersistentThrustEnabled(this Vessel vessel)
        {
            ...
            if (PEmoduleList.Count() == 0)
                hasPersistentThrustEnabled = false;
            else
                hasPersistentThrustEnabled = PEmoduleList.All(module => module.HasPersistentThrust);
        ...
        public static void ResetPTEnabledCheck(this Vessel vessel)
        {
            didCheckPTEnabled = false;
        }

        public static void SetVesselWidePersistentThurst(this Vessel vessel, bool isOn)
        {
            var PEmoduleList = vessel.FindPartModulesImplementing<PersistentEngine>();
